...
const navItems = [
  ...
  { href: '/dashboard/documents', label: 'Documente', icon: 'file' },
  { href: '/dashboard/invoicing', label: 'Facturare', icon: 'receipt' },
...
function Icon({ name }: { name: string }) {
  ...
  switch (name) {
    ...
    case 'users':
      return (
        <svg className={common} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-4.13a4 4 0 11-8 0 4 4 0 018 0zm6 4a4 4 0 10-8 0" />
        </svg>
      );
    case 'file':
      return (
  ...
  return (
    <aside className="w-56 shrink-0 bg-white border-r border-gray-200 min-h-screen p-4">
      <div className="mb-6 px-2">
        <p className="text-lg font-bold text-blue-800">🌊 Sesflow</p>
      </div>
